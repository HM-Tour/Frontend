...
export default function Footer() {
    ...
    return (
        <footer className="bg-gray-100" style={bg}>
            ...
            <div className="py-5">
                <div className="flex gap-6 text-orange-800 justify-center">
                ...
                <p className="py-5 text-orange-800">Copyright © <span id="get-current-year">2023</span> All rights reserved | This Website is made by HM-Tour team</p>
                <p className="text-orange-800 text-center">Terms & Condition</p>
